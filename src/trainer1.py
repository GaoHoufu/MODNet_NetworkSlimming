...
def supervised_training_iter(
    ...
    semantic_scale=10.0, detail_scale=10.0, matte_scale=1.0, compactor_mask_dict=None,scaler =None):
    ...
    with amp.autocast():
        ...
        pred_semantic, pred_detail, pred_matte = pred_semantic.float(), pred_detail.float(), pred_matte.float()
        gt_matte = gt_matte.float()
